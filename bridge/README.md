...
The daemon scans `factory/teams/*/inbox` for assignment markdown, receives `POST /a2a/push`, writes `factory/status/a2a-bridge.json`, and stops when `factory/HALT_a2a-bridge.flag` exists.
